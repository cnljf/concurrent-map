...
func GetSet(m ConcurrentMap, finished chan struct{}) (get func(key, value string), set func(key, value string)) {
...
func runWithShards(bench func(b *testing.B, shardCount int), b *testing.B, shardsCount int) {
	bench(b, shardsCount)
}
